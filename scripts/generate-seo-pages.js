...
@media(max-width:650px){.site-head{display:grid;grid-template-columns:1fr;gap:10px;align-items:stretch;padding:calc(12px + env(safe-area-inset-top,0px)) 12px 11px}.logo{width:max-content;max-width:100%;font-size:.95rem}.site-head nav{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:7px;width:100%;justify-content:stretch}.site-head nav a{width:100%;min-width:0;min-height:44px;padding:9px 7px;border:1px solid rgba(255,255,255,.08);background:rgba(255,255,255,.045);font-size:.75rem;text-align:center;white-space:nowrap}.page{width:min(100% - 22px,var(--max));padding-top:16px}.hero{gap:18px}.hero-image{min-height:320px;border-radius:28px}.hero-image img{height:320px}.hero h1,.listing-hero h1{font-size:clamp(3.5rem,20vw,5.8rem)}.content-grid{margin-top:20px}.box,.cta,.person-card{padding:16px;border-radius:23px}.notes,.details,.cards,.listing-cards,.people,.site-foot{grid-template-columns:1fr}.section-head{align-items:start}.card-img{height:260px}.site-foot{width:calc(100% - 22px);padding:18px}.foot-links{justify-content:flex-start}.hero-actions,.cta-actions{display:grid}.hero-actions a,.cta-actions a,.cta-actions button{width:100%}}@media(max-width:360px){.site-head nav{grid-template-columns:1fr}.site-head nav a{min-height:42px}.logo{font-size:.88rem}}`;
}
